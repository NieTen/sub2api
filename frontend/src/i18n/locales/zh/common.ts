export default {
  ...
  auth: {
    ...
    loginHeroDescription: '邮箱、Passkey、OAuth、2FA 和验证码都保留，登录在桌面端和手机端都保持顺手。',
    loginFeatureOneTitle: '保留验证码',
    loginFeatureOneDesc: 'Turnstile、腾讯和阿里云验证继续可用。',
    loginFeatureTwoTitle: '多种登录方式',
    loginFeatureTwoDesc: '密码、Passkey、OAuth 和 2FA 都能继续使用。',
    loginFeatureThreeTitle: '多端适配',
    loginFeatureThreeDesc: '桌面与手机都保持一致的登录体验。',
    registerHeroDescription: '邮箱验证、邀请码和优惠码都保留，注册流程在手机端也能完整完成。',
    registerFeatureOneTitle: '验证码继续',
    registerFeatureOneDesc: '注册时的人机验证能力不会丢。',
    registerFeatureTwoTitle: '邮箱验证保留',
    registerFeatureTwoDesc: '注册数据会继续流转到验证码页。',
    registerFeatureThreeTitle: '手机端同步',
    registerFeatureThreeDesc: '邀请、优惠码和表单布局都适配小屏幕。',
    processing: '处理中...',
    continue: '继续',
    rememberMe: '记住我',
