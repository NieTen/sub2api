export default {
  ...
  auth: {
    ...
    signUp: '注册',
    splitBadge: '桌面端和手机端同步',
    navigationLabel: '站点导航',
    accountNavigationLabel: '账户入口',
    homeLink: '首页',
    modelsLink: '模型广场',
    quickStartLink: '快速开始',
    switchLanguage: 'Switch to English',
    workspaceKicker: 'AI 开发工作台',
    codingAccessTitle: 'Codex / Claude Code 稳定接入',
    loginHeroDescription: '在一个控制台管理模型接入、API Key 和调用用量，让日常开发更专注。',
    loginFeatureOneTitle: '多模型接入',
    loginFeatureOneDesc: '按任务选择模型，连接常用开发工具。',
    loginFeatureTwoTitle: '密钥管理',
    loginFeatureTwoDesc: '创建和管理 API Key，按应用分配使用。',
    loginFeatureThreeTitle: '用量可查',
    loginFeatureThreeDesc: '查看调用记录与费用，了解每次使用。',
    registerHeroDescription: '创建账户后即可进入控制台，选择模型、配置 API Key，开始连接你的应用。',
    registerFeatureOneTitle: '模型广场',
    registerFeatureOneDesc: '浏览可用模型与价格，选择合适的能力。',
    registerFeatureTwoTitle: '统一接入',
    registerFeatureTwoDesc: '通过 API Key 接入应用和开发工具。',
    registerFeatureThreeTitle: '用量管理',
    registerFeatureThreeDesc: '在控制台查看调用明细与账户余额。',
    registerEmailVerificationDescription: '完成邮箱验证后进入控制台，即可创建 API Key 并配置模型接入。',
    registerAccountDescription: '创建账户后进入控制台，即可创建 API Key 并配置模型接入。',
    registerBenefitModels: '多模型接入',
    registerBenefitKeys: '密钥管理',
    registerBenefitUsage: '用量明细',
    processing: '处理中...',
    continue: '继续',
    rememberMe: '记住我',
