export default {
  ...
  auth: {
    ...
    loginHeroDescription:
      'Email, passkey, OAuth, 2FA, and captcha all stay in place, so sign-in feels smooth on desktop and mobile.',
    loginFeatureOneTitle: 'Captcha stays on',
    loginFeatureOneDesc: 'Turnstile, Tencent, and Aliyun verification still works.',
    loginFeatureTwoTitle: 'Multiple sign-in paths',
    loginFeatureTwoDesc: 'Password, passkey, OAuth, and 2FA all remain available.',
    loginFeatureThreeTitle: 'Mobile-ready',
    loginFeatureThreeDesc: 'The sign-in flow stays consistent on smaller screens.',
    registerHeroDescription:
      'Email verification, invitation codes, and promo codes all stay in place, and registration still works smoothly on mobile.',
    registerFeatureOneTitle: 'Captcha kept',
    registerFeatureOneDesc: 'Human verification stays available during sign-up.',
    registerFeatureTwoTitle: 'Email verification',
    registerFeatureTwoDesc: 'Registration still continues through the verification page.',
    registerFeatureThreeTitle: 'Mobile-ready',
    registerFeatureThreeDesc: 'Invites, promo codes, and the form all adapt to small screens.',
    processing: 'Processing...',
    continue: 'Continue',
