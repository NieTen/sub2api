export default {
  ...
  auth: {
    ...
    signUp: 'Sign up',
    splitBadge: 'Desktop and mobile synced',
    navigationLabel: 'Site navigation',
    accountNavigationLabel: 'Account access',
    homeLink: 'Home',
    modelsLink: 'Models',
    quickStartLink: 'Quick start',
    switchLanguage: '切换到中文',
    workspaceKicker: 'AI developer workspace',
    codingAccessTitle: 'Reliable access to Codex / Claude Code',
    loginHeroDescription:
      'Manage model access, API keys, and usage in one console, and stay focused on building.',
    loginFeatureOneTitle: 'Model access',
    loginFeatureOneDesc: 'Choose models for your tasks and connect your developer tools.',
    loginFeatureTwoTitle: 'API keys',
    loginFeatureTwoDesc: 'Create and manage API keys for each application.',
    loginFeatureThreeTitle: 'Usage details',
    loginFeatureThreeDesc: 'Review request history and costs for each call.',
    registerHeroDescription:
      'Create an account to open your console, choose models, configure API keys, and connect your application.',
    registerFeatureOneTitle: 'Model catalog',
    registerFeatureOneDesc: 'Browse available models and prices for your needs.',
    registerFeatureTwoTitle: 'One connection',
    registerFeatureTwoDesc: 'Connect applications and developer tools with API keys.',
    registerFeatureThreeTitle: 'Usage control',
    registerFeatureThreeDesc: 'Review request details and your account balance in the console.',
    registerEmailVerificationDescription:
      'Verify your email to open the console, create an API key, and configure model access.',
    registerAccountDescription:
      'Create an account to open the console, create an API key, and configure model access.',
    registerBenefitModels: 'Model access',
    registerBenefitKeys: 'API keys',
    registerBenefitUsage: 'Usage details',
    processing: 'Processing...',
    continue: 'Continue',
