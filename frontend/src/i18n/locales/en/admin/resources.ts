export default {
    scheduledTests: {
      ...
      batchCreate: {
        title: 'Batch Create Scheduled Tests',
        selected: 'Create the same plan for {count} account(s)',
        submit: 'Batch Create',
        summary: 'Creation completed: {success} succeeded, {failed} failed',
        success: 'Batch creation completed: {count} succeeded',
        partial: 'Batch creation partially completed: {success} succeeded, {failed} failed',
        failed: 'Failed to batch create scheduled tests',
