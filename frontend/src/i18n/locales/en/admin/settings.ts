export default {
    settings: {
      ...
      site: {
        ...
        homeContentPlaceholder: 'Leave empty to use the built-in home page. For a custom page, enter HTML or an external URL that allows embedding, such as https://example.com.',
        homeContentHint: 'The built-in home page is integrated directly and needs no page URL. Configure its models and prices in Home Models & Pricing. HTML replaces the default page; a URL embeds the target page in an iframe and requires the target to allow embedding.',
