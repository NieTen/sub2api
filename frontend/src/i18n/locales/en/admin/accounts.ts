export default {
    accounts: {
      ...
      dataImportHint: 'Import from multiple JSON files, pasted text, or drag-and-drop. The app auto-detects CPA or sub2api structures and merges them into one import payload.',
      dataImportWarning: 'This screen imports accounts only. It creates new accounts; groups still need to be bound manually, and existing data should not conflict.',
      dataImportFile: 'Import file',
      dataImportButton: 'Import Now',
      dataImporting: 'Importing...',
      dataImportSelectFile: 'Please select a JSON file',
      dataImportParseFailed: 'Failed to parse pasted text',
      dataImportParseFailedFile: 'Failed to parse {name}',
      dataImportInvalidFile: '{name} is not a supported account import file',
      dataImportIgnoredFiles: 'Ignored {count} non-JSON file(s)',
      dataImportFailed: 'Account import failed',
      dataImportText: 'Paste JSON directly',
      dataImportPlaceholder: 'Supports a single object, arrays, NDJSON, consecutive JSON objects, or a sub2api import payload.',
      dataImportTextHint: 'Paste CPA auth JSON, a sub2api import payload, or multiple JSON objects. They will be normalized into one import package.',
      dataImportTextSource: 'pasted text',
      dataImportDropHint: 'Drag multiple .json files here. Files are read only in this browser session.',
      dataImportClear: 'Clear',
      dataImportOutputTitle: 'Generated payload',
      dataImportOutputHint: 'This is the sub2api data package you can import directly into the platform, or copy/download.',
      dataImportCopy: 'Copy JSON',
      dataImportDownload: 'Download JSON',
      dataImportInputRecords: 'Input records',
      dataImportAccounts: 'Accounts',
      dataImportProxies: 'Proxies',
      dataImportSkipped: 'Skipped',
      dataImportPreviewTitle: 'Account preview',
      dataImportPreviewEmpty: 'Waiting for input',
      dataImportSource: 'Source',
      dataImportSourceCpa: 'CPA',
      dataImportSourceSub2Api: 'sub2api',
      dataImportIssues: 'Conversion notes',
      dataImportOutputPlaceholder: 'The parsed result will appear here',
      dataImportCopied: 'JSON copied to clipboard',
      ...
      bulkActions: {
        ...
        refreshToken: 'Refresh Token',
        batchTest: 'Batch Test Connections',
        batchSchedule: 'Batch Schedule Tests',
      ...
      openai: {
        ...
        codexQuotaOverdraftDesc:
          'Control whether this account can continue after Codex quota is exhausted, and which account types may participate.',
        codexQuotaOverdraftOAuth: 'Allow OAuth participation',
        codexQuotaOverdraftOAuthDesc: 'OAuth accounts participate in overdraft by default.',
        codexQuotaOverdraftSetupToken: 'Allow Setup Token participation',
        codexQuotaOverdraftSetupTokenDesc:
          'When enabled, Setup Token accounts can continue after the current group overdrafts.',
      ...
      batchTest: {
        ...
        start: 'Start Test',
        running: 'Testing...',
        runningWithConcurrency: 'Running connection tests with 15 concurrent workers...',
        ready: 'Click start to test the selected accounts concurrently.',
        successCount: '{count} succeeded',
        failedCount: '{count} failed',
        completed: 'Batch test completed: {count} succeeded',
        partial: 'Batch test partially completed: {success} succeeded, {failed} failed',
        failed: 'Batch connection test failed',
        columns: {
          account: 'Account',
          latency: 'Latency',
          responded: 'Responded',
