  ...
  keys: {
    ...
    useKeyModal: {
      ...
      openai: {
        ...
        codexQuotaOverdraftDesc: 'Control whether this account can continue after Codex quota is exhausted, and which account types may participate.',
        ...
        codexQuotaOverdraftSetupTokenDesc: 'When enabled, Setup Token accounts can continue after the current group overdrafts.',
      },
      cliTabs: {
