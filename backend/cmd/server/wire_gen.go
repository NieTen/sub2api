...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	supportDeliveryService := service.ProvideSupportDeliveryService(settingRepository, emailService, supportTicketRepository, supportTicketService)
	communityService := service.ProvideCommunityService(settingRepository, communityRepository, supportDeliveryService)
	...
	bulkEmailRepository := repository.NewBulkEmailRepository(db)
	bulkEmailService := service.ProvideBulkEmailService(bulkEmailRepository, emailService, supportTicketRepository)
	supportDeliveryHandler := handler.NewSupportDeliveryHandler(supportDeliveryService, bulkEmailService, communityService)
