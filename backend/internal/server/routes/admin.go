...
func RegisterAdminRoutes(
	...
	registerSupportAdminRoutes(admin, h)
	{
		// 部署与运营合规确认
...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		adminSettings.GET("/home-models", h.Admin.Setting.GetHomeModels)
		adminSettings.PUT("/home-models", h.Admin.Setting.UpdateHomeModels)
...
func registerScheduledTestRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	plans := admin.Group("/scheduled-test-plans")
	{
		...
		plans.POST("/batch", h.Admin.ScheduledTest.CreateBatch)
...
func registerChannelRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	channels := admin.Group("/channels")
	{
		...
		channels.POST("/model-pricing/batch", h.Admin.Channel.GetHomeModelSystemPrices)
